...
\ifdefined\ISBLUEPRINT
\begin{center}
\noindent
\textsf{\href{index.html}{Notes} \quad | \quad \href{dep_graph_document.html}{Dependency Graph}}
\end{center}
\medskip
\fi
...
\begin{definition} \label{def:monoid-homomorphism}
...
\begin{proposition} \label{prop:image-of-monoid-homomorphism}
...
\begin{definition} \label{def:divisor-closed-submonoid}
	\uses{def:divisibility,def:submonoid}
...
\begin{proposition} \label{prop:divisor-closed-submonoid-of-puiseux-monoid}
	\uses{def:divisor-closed-submonoid}
...
\begin{proposition} \label{prop:isomorphism-preserves-cancellative}
	\uses{def:monoid-homomorphism}
...
\begin{proposition} \label{prop:grothendieck-group-universal-property}
...
\begin{proposition} \label{prop:subgroup-realizing-grothendieck-group}
	\uses{def:grothendieck-group,prop:grothendieck-group-universal-property}
...
\begin{theorem} \label{thm:isomorphism-extends-to-grothendieck-group}
	\uses{prop:localization-of-monoid,def:grothendieck-group}
...
\begin{example} \label{ex:grothendieck-group-of-a-numerical-monoid}
...
\begin{definition} \label{def:product-monoid}
...
\begin{proposition} \label{prop:units-reduced-group-of-product-monoid}
	\uses{def:product-monoid}
...
\begin{definition} \label{def:internal-product-of-monoids}
	\uses{def:product-monoid}
